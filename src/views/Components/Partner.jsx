...
class Partner extends React.Component {
    ...
    let data = dict.response.data.map(c => {
      ...
      row['actions'] = (
        <div className="customers-actions">
            ...
            <Button  color="info" authority="customers_view_mr" onClick={() => this.openDelete(c)}>
  ...
  Delete = (idv, onSucess, onError) => {
    ...
    var datav = {model: "partners", data: {id: idv}}
  ...
  updateDatabase = (onSucess, onError) => {
    ...
    var datav = {model: "partner", data: this.state.data}
